...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white pt-24 p-8 flex items-center justify-center">
      <div className="bg-white text-gray-900 p-8 rounded-2xl shadow-2xl max-w-3xl mx-auto">
        ...
        <h2 className="text-2xl font-bold mb-4">I. Introduction</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">II. General Provisions</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">III. Definitions</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">IV. Restrictions</h2>
        ...
        <h2 className="text-2xl font-bold mb-4">V. Customer Account Registration</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">VI. Orders</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">VII. Payments</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">VIII. Product Delivery</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">IX. No Warranties</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">X. Warranty and Liability</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">XI. Complaints and Dispute Resolution</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">XV. Website Use</h2>
        <p className="mb-6 text-lg leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mb-4">XVI. Final Provisions</h2>
        <p className="mb-6 text-lg leading-relaxed">

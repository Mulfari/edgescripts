...
const InicioProducts = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-start h-full text-left text-white pl-40">
        <h1 className="text-4xl font-bold text-blue-500 mx-auto" style={{ fontFamily: '"Press Start 2P", cursive' }}>Products</h1>
      </div>
    </div>
  );
};
